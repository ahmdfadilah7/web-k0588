        ...
        <div class="card-body">
            ...
            {!! Form::model($setting, ['method' => 'post', 'route' => ['sistem.setting.update', $setting->id], 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="name_website" class="form-control" value="{{ $setting->name_website }}">
                ...
                <div class="form-group mb-3">
                    @if ($setting->gambar_header <> '' || $setting->gambar_header <> null)
                        <label for="" class="form-label">Gambar Header Sebelumnya</label><br>
                        <img src="{{ url($setting->gambar_header) }}" width="150"><br>
                    @endif
                ...
                <div class="form-group mb-3">
                    @if ($setting->logo <> '' || $setting->logo <> null)
                        ...
                        <img src="{{ url($setting->logo) }}" width="150"><br>
                    @endif
                ...
                <div class="form-group mb-3">
                    @if ($setting->favicon <> '' || $setting->favicon <> null)
                        ...
                        <img src="{{ url($setting->favicon) }}" width="150"><br>
                    @endif
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="address" rows="5" class="form-control">{{ $setting->address }}</textarea>
                    <i class="text-danger">{{ $errors->first('address') }}</i>
                </div>
                <div class="form-group mb-4">
                    <label for="" class="form-label">About Us</label>
                    <textarea name="about_us" rows="5" class="form-control">{{ $setting->about_us }}</textarea>
